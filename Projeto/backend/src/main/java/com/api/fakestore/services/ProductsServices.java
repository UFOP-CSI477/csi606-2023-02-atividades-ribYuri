...
public class ProductsServices {
    ...
    public List<ProductOutput> findAll(String column, String order) {
        Sort sort = Sort.by(Sort.Direction.valueOf(order.toUpperCase()), column);
        return ProductUtils.makeProductOutputList(productsRepository.findAll(sort));
    }

    public List<ProductOutput> searchProducts(String query) {
        return ProductUtils.makeProductOutputList(productsRepository.findByTitleContainingIgnoreCase(query));
    }
